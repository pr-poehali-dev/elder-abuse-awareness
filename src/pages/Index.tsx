...
const Index = () => {
  ...
  const resources = [
    ...
    { name: 'Социальная защита', contact: 'Управление социальной защиты населения по городу Барнаулу. Комплексный центр социального обслуживания населения города Барнаула', icon: 'Building2' },
